...
export function VariablesScaffold() {
  ...
  const [_completed, setCompleted] = useState<string[]>([]);
  ...
  if (phase === 'phase1') {
    return (
      <section ref={ref} className="py-20 px-4 bg-gradient-to-br from-green-50 to-teal-50 dark:from-gray-900 dark:to-slate-900">
              ...
              {data.phase1.steps.map((step, idx) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <p className="text-lg font-semibold text-gray-800 dark:text-gray-100">{step.text}</p>
                  </div>
                  <motion.div
  ...
  if (phase === 'phase2') {
    return (
      <section ref={ref} className="py-20 px-4 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-900 dark:to-slate-900">
        <div className="max-w-3xl mx-auto w-full">
          <motion.h2 className="text-3xl md:text-4xl font-extrabold text-center mb-4" initial={{ opacity: 0, y: -20 }} animate={isVisible ? { opacity: 1, y: 0 } : {}}>
            ...
            <div className="space-y-6">
              {data.phase2.steps.slice(1).map((step, idx) => (
                <div key={step.id || idx} className="flex items-center gap-4">
                  <span className="text-lg font-bold text-gray-500 dark:text-gray-400">Block {idx + 2}:</span>
                  {idx === 0 && (
                    <input
                      className="flex-1 px-4 py-3 rounded-xl border-2 border-blue-200 dark:border-blue-800 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 text-center font-mono text-lg focus:border-blue-500 outline-none transition-colors"
    ...
    return (
      <section ref={ref} className="py-20 px-4 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-900 dark:to-slate-900">
        <div className="max-w-3xl mx-auto w-full">
          ...
          <p className="text-center text-gray-500 dark:text-gray-400 mb-8 text-lg">ঠিক ব্লকটি টেনে সঠিক জায়গায় ফেলো</p>
              ...
              <motion.button
                ...
                className={`px-4 py-3 rounded-xl font-mono font-bold text-sm cursor-grab active:cursor-grabbing shadow-md transition-all ${
                  dropped.includes(block.id)
                    ...
                    : 'bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 border-2 border-blue-300 dark:border-blue-600 hover:border-blue-500'
                }`}
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-lg font-semibold text-gray-800 dark:text-gray-100">{dz.label}</span>
    ...
    <section ref={ref} className="py-20 px-4 bg-gradient-to-br from-green-50 to-teal-50 dark:from-gray-900 dark:to-slate-900">
      <div className="max-w-3xl mx-auto w-full text-center">
        <Card highlighted className="max-w-md mx-auto">
          ...
          <p className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-2">ভেরিয়েবল তৈরি করতে পারো!</p>
          <p className="text-gray-500 dark:text-gray-400">তুমি এখন Make a Variable → set → change পদ্ধতি জানো</p>
        </Card>
      </div>
    </section>
  );
