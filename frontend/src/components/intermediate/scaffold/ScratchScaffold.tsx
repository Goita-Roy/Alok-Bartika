        ...
        <AnimatePresence mode="wait">
            ...
            <motion.div key="p1" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="text-center">
              <Card>
                ...
                <div className="space-y-4">
                  <motion.div className="p-6 bg-emerald-500/10 border-2 border-emerald-500 rounded-xl">
                    <p className="text-lg font-bold text-gray-800 dark:text-gray-100">আমরা দেখবো কিভাবে Scratch-এ Event Block ব্যবহার করতে হয়</p>
                  </motion.div>
                </div>
                <div className="mt-6">
          ...
          {phase === 'phase1-sprite' && (
            <motion.div key="p1s" initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -30 }} className="text-center">
              <Card>
                <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-4">Step 1</h3>
          ...
          {phase === 'phase1-hat' && (
            <motion.div key="p1h" initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -30 }}>
              <Card>
                <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-4 text-center">Step 2</h3>
                ...
                <p className="text-center text-sm text-gray-500 dark:text-gray-400 mb-4">Hat Block — ইভেন্ট ব্লকটি টেনে আনো</p>
          ...
          {phase === 'phase1-block' && (
            <motion.div key="p1b" initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -30 }}>
              <Card>
                <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-4 text-center">Step 3</h3>
                ...
                <p className="text-center text-sm text-gray-500 dark:text-gray-400 mb-4">Motion Block — নিচে যোগ করো</p>
                <div className="text-center">
          ...
          {phase === 'phase1-connect' && (
            <motion.div key="p1c" initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -30 }}>
              <Card>
                <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-4 text-center">Step 4</h3>
          ...
          {phase === 'phase1-flag' && (
            <motion.div key="p1f" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="text-center">
              <Card>
                <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-4">Step 5</h3>
                ...
                {!spriteMoved && <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Green Flag 🚩 এ ক্লিক করো</p>}
                {spriteMoved && (
          ...
          {phase === 'phase2' && (
            <motion.div key="p2" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -50 }}>
              <Card>
                <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-4 text-center">তুমি নিজে করো (Try Yourself)</h3>
                ...
                {submitted && (
                  <motion.div className="mt-6 text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                    {isCorrect ? (
                      <div>
                        <p className="text-emerald-500 font-bold text-lg mb-4">✓ সঠিক! ব্লক দুটি সঠিকভাবে সংযুক্ত!</p>
                        <div className="flex flex-col items-center gap-0 mb-4">
                      ...
                      <div>
                        <p className="text-red-500 font-bold text-lg mb-4">✗ ক্রমটি সঠিক নয়। Hat Block উপরে রাখো।</p>
          ...
          {phase === 'done' && (
            <motion.div key="done" initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} className="text-center">
              <Card highlighted className="max-w-md mx-auto">
                ...
                <p className="text-xl font-bold text-gray-800 dark:text-gray-100">তুমি ইভেন্ট ব্লক ব্যবহার করতে শিখেছ!</p>
              </Card>
            </motion.div>
          )}
        </AnimatePresence>
