...
const dragBlocks = [
  ...
  { id: 'say-pass', label: 'say "পাস!"', color: 'bg-emerald-500' },
          ...
          <Card>
            {!showCheck ? (
              <div className="text-center">
                ...
                <p className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-4">কম্পিউটার স্কোর পরীক্ষা করছে...</p>
                <p className="text-gray-500 dark:text-gray-400 mb-6">একটি স্কোর নির্বাচন করো:</p>
              ...
              <div className="text-center">
                <p className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-2">Score = {scoreValue}</p>
                {scoreValue !== null && scoreValue >= 50 ? (
                  <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} className="p-6 bg-green-50 dark:bg-green-900/20 rounded-2xl border-2 border-green-400">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-2">শর্ত সত্যি → True Block চলেছে</p>
                  </motion.div>
                ) : (
                  <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} className="p-6 bg-orange-50 dark:bg-orange-900/20 rounded-2xl border-2 border-orange-400">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-2">শর্ত মিথ্যা → Else Block চলেছে</p>
                  </motion.div>
                )}
    ...
    return (
      <section ref={ref} className="py-20 px-4 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-900 dark:to-slate-900">
        <div className="max-w-3xl mx-auto w-full">
          ...
          <p className="text-center text-gray-500 dark:text-gray-400 mb-8 text-lg">ঠিক ব্লকটি বাছাই করে সঠিক জায়গায় ফেলো</p>
    ...
    <section ref={ref} className="py-20 px-4 bg-gradient-to-br from-green-50 to-teal-50 dark:from-gray-900 dark:to-slate-900">
      <div className="max-w-3xl mx-auto w-full text-center">
        <Card highlighted className="max-w-md mx-auto">
          ...
          <p className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-2">If-Else তৈরি করতে পারো!</p>
          <p className="text-gray-500 dark:text-gray-400">তুমি এখন If → Condition → Then → Else → False Block সাজাতে জানো</p>
        </Card>
      </div>
    </section>
  );
