...
export function ScratchChallenge() {
  ...
  return (
    <section ref={ref} className="py-20 px-4 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-gray-900 dark:to-slate-900">
          ...
          {step === 'intro' && (
            <motion.div key="intro" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="text-center">
              <Card>
                ...
                <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">চূড়ান্ত চ্যালেঞ্জ</h3>
                <div className="space-y-4 text-left mb-6">
                  ...
                  <div className="bg-yellow-50 dark:bg-yellow-900/20 border-2 border-yellow-400 rounded-xl p-4">
                    <p className="font-bold text-gray-800 dark:text-gray-100">💡 ইঙ্গিত:</p>
                    <p className="text-gray-500 dark:text-gray-400">Hat Block (When...) সবসময় উপরে থাকে</p>
                  </div>
                </div>
          ...
          {step === 'failure' && (
            <motion.div key="failure" initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0 }} className="text-center">
              <Card>
                ...
                <h3 className="text-2xl font-bold text-red-500 mb-4">সম্পূর্ণ সঠিক নয়</h3>
                <p className="text-gray-500 dark:text-gray-400 mb-2">প্রতিটি Hat Block-এর নিচে সঠিক Motion Block বসাও।</p>
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">প্রচেষ্টা: {attempts}</p>
