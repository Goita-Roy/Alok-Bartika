          ...
          {!completed ? (
                ...
                <div className="flex flex-col md:flex-row items-center gap-8">
                  <div className="flex-1 flex justify-center">
                    <motion.div className="relative w-48 h-48 md:w-56 md:h-56" initial={{ scale: 0 }} animate={isVisible ? { scale: 1 } : {}} transition={{ type: 'spring', delay: 0.3 }}>
                      <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/20 to-sky-500/20 rounded-3xl" />
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <motion.h3 className="text-2xl font-bold text-emerald-500 mb-6" initial={{ opacity: 0, x: 20 }} animate={isVisible ? { opacity: 1, x: 0 } : {}} transition={{ delay: 0.4 }}>
                      {term}
                    </motion.h3>
                    ...
                    <div className="min-h-[120px]">
                      {showTyping && (
                        <p className="text-lg leading-relaxed text-gray-800 dark:text-gray-100">
                          {typedText}
                          {!showButton && <span className="inline-block w-0.5 h-5 bg-emerald-500 ml-1 animate-pulse" />}
                        </p>
                      )}
                    </div>
            ...
            <motion.div key="completed" initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} className="text-center">
              <Card highlighted className="max-w-md mx-auto">
                ...
                <p className="text-xl font-bold text-gray-800 dark:text-gray-100">দারুণ! তুমি সংজ্ঞাটি বুঝতে পেরেছো!</p>
              </Card>
            </motion.div>
          )}
        </AnimatePresence>
