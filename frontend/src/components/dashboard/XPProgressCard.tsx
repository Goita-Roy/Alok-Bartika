    ...
    <section className="rounded-[24px] p-6 h-full"
      ...
      <div className="flex flex-col gap-5">
        <div className="flex items-start justify-between">
          <div>
            <p className="text-sm font-bold text-white/70 mb-1" style={{ fontFamily: "'Hind Siliguri', sans-serif" }}>মোট স্কোর</p>
            <h2 className="text-5xl font-black text-white tracking-tight">{formatBanglaNumber(totalXP)}</h2>
          </div>
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-between text-sm">
            <span className="text-white/80 font-semibold" style={{ fontFamily: "'Hind Siliguri', sans-serif" }}>
              {formatBanglaNumber(Math.round(progress))}% সম্পন্ন
            </span>
            <span className="text-white/80 font-semibold" style={{ fontFamily: "'Hind Siliguri', sans-serif" }}>
              {formatBanglaNumber(remaining)} স্কোর বাকি → লেভেল {formatBanglaNumber(level + 1)}
            </span>
          </div>
        </div>
      </div>
