...
const keywords = [
  { word: "কাঁচা তথ্য (Data)", color: "#38bdf8" },
  { word: "নির্দিষ্ট নির্দেশনাবলী (Instructions)", color: "#c084fc" },
  { word: "প্রক্রিয়াকরণ (Process)", color: "#f472b6" },
  { word: "আউটপুট (Output)", color: "#34d399" },
];

const floatingIcons = [
  { Icon: Cpu, x: "10%", y: "20%", delay: 0, color: "#c084fc" },
  { Icon: Monitor, x: "85%", y: "30%", delay: 1, color: "#38bdf8" },
  { Icon: HardDrive, x: "15%", y: "70%", delay: 2, color: "#34d399" },
  { Icon: Zap, x: "80%", y: "75%", delay: 0.5, color: "#f472b6" },
];

export default function Section1_Definition() {
  return (
    <SectionWrapper
      id="definition"
      title="সংজ্ঞা"
    ...
    >
      <div className="relative">
          ...
          <div className="relative z-10">
            <p className="text-base md:text-lg leading-relaxed md:leading-8 text-slate-200">
              ...
              <motion.span
                ...
                style={{ "--keyword-color": keywords[0].color } as React.CSSProperties}
              >
                ইলেকট্রনিক ডিভাইস
              </motion.span>{" "}
              যা{" "}
              ...
              করে এবং অত্যন্ত নিখুঁতভাবে ফলাফল বা{" "}
              <motion.span
                className="keyword-highlight"
        ...
        >
          ...
          <motion.div className="relative z-10 flex items-start gap-4">
            ...
            <p className="text-base md:text-lg leading-relaxed md:leading-8 text-slate-300">
              &apos;কম্পিউটার&apos; শব্দটি এসেছে গ্রিক শব্দ &apos;Compute&apos; থেকে, যার অর্থ{" "}
              <motion.span
                className="keyword-highlight"
              ...
              । তবে আজকের কম্পিউটার শুধু গণনাকারী যন্ত্র নয়, এটি{" "}
              <motion.span
                className="keyword-highlight"
                style={{ borderColor: "#38bdf8", color: "#38bdf8" }}
                whileHover={{ scale: 1.05 }}
              >
                আধুনিক সভ্যতার চালিকাশক্তি
              </motion.span>
              ।
            </p>
          </motion.div>
        ...
        <motion.div
          ...
          className="beginner-topic-chips mt-6 grid grid-cols-2 gap-3 sm:grid-cols-4"
        >
          {[
            { label: "ইনপুট", icon: "📥", color: "from-blue-500/20 to-blue-600/10" },
            { label: "প্রসেস", icon: "⚙️", color: "from-purple-500/20 to-purple-600/10" },
            { label: "আউটপুট", icon: "📤", color: "from-green-500/20 to-green-600/10" },
            { label: "স্টোরেজ", icon: "💾", color: "from-pink-500/20 to-pink-600/10" },
          ].map((item, i) => (
            <motion.div
              key={i}
              whileHover={{ scale: 1.1, y: -5 }}
              whileTap={{ scale: 0.95 }}
              className={`flex min-h-12 w-full items-center justify-center px-3 py-2 rounded-xl bg-gradient-to-br ${item.color} border border-white/10 backdrop-blur-sm cursor-pointer`}
            >
