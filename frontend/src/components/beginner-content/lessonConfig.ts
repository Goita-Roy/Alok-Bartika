...
const classSectionIds: Record<string, string[]> = {
  ...
  "class-05": ["input-definition", "input-brain-teaser", "input-real-life", "input-how-it-works", "input-animation", "mouse-training"],
  "class-06": ["output-definition", "output-brain-teaser", "output-real-life", "output-how-it-works", "output-animation", "output-target-challenge"],
...
const classSectionLabels: Record<string, string[]> = {
  ...
  "class-05": ["Input Def", "Input Q", "Input Real", "Input How", "Input Anim", "Mouse Game"],
  "class-06": ["Output Def", "Output Q", "Output Real", "Output How", "Output Anim", "Target Challenge"],
