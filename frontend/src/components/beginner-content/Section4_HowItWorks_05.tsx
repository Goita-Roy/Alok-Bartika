...
import { Keyboard, Cpu, Monitor, Binary, Zap, ArrowRight, RotateCcw, CircuitBoard } from "lucide-react";
import SectionWrapper from "./SectionWrapper";

const flowSteps = [
  { id: "press", label: "কী-প্রেস", icon: "⌨️", color: "#38bdf8", desc: "সার্কিটে বৈদ্যুতিক সংযোগ" },
  { id: "detect", label: "শনাক্তকরণ", icon: "🔍", color: "#c084fc", desc: "কিবোর্ড প্রসেসর বুঝতে পারে" },
  { id: "binary", label: "বাইনারি কোড", icon: "🔢", color: "#f472b6", desc: "01000001 তে রূপান্তর" },
  { id: "cpu", label: "CPU তে পাঠায়", icon: "⚡", color: "#34d399", desc: "সিপিইউ-তে পৌঁছায়" },
  { id: "display", label: "স্ক্রিনে দেখায়", icon: "🖥️", color: "#fbbf24", desc: "'A' ফুটিয়ে তোলে" },
];

export default function Section4_HowItWorks_05() {
  ...
  const keyPhrases = [
    { text: "তুমি যখন কিবোর্ডের 'A' বোতামে চাপ দাও, তখন কিবোর্ডের নিচের সার্কিটে একটি বৈদ্যুতিক সংযোগ তৈরি হয়।" },
    { text: "কিবোর্ড প্রসেসর বুঝতে পারে 'A' চাপানো হয়েছে।" },
    { text: "সে তখন 'A'-কে বাইনারি কোডে (যেমন: 01000001) রূপান্তর করে সিপিইউ-তে পাঠিয়ে দেয়।" },
    { text: "সিপিইউ তখন স্ক্রিনে 'A' ফুটিয়ে তোলে।" },
  ];
      ...
      <div className="space-y-6">
        ...
        >
          <p className="text-base md:text-lg text-slate-300">
            তুমি যখন কিবোর্ডের 'A' বোতাম চাপো, তখন কীভাবে তা কম্পিউটারের স্ক্রিনে 'A' হয়ে ফুটে ওঠে? নিচের ধাপগুলো দেখো:
          </p>
        </motion.div>

        {/* Flow Steps - Vertical on mobile, Horizontal on desktop */}
        ...
        >
          ...
          <div className="relative z-10">
            <h4 className="text-lg md:text-xl font-bold text-center mb-6 text-gradient">
              কিবোর্ড 'A' কী-প্রেস সিমুলেশন
            </h4>

            {/* Key Press Visual */}
            <div className="flex justify-center mb-6">
              <motion.div
                animate={activePhase >= 0 ? { y: [0, 3, 0], scale: [1, 0.95, 1] } : {}}
                transition={{ duration: 0.3, repeat: activePhase >= 0 ? 3 : 0 }}
                className="w-16 h-16 md:w-20 md:h-20 glass rounded-xl flex items-center justify-center text-2xl md:text-3xl font-bold text-cyan-300 border border-white/20"
              >
                A
              </motion.div>
            </div>
              ...
              {activePhase >= 2 && (
                ...
                >
                  <div className="flex items-center justify-center gap-2 mb-2">
                    ...
                    <span className="text-xs text-slate-400">বাইনারি কোড</span>
                  </div>
                  <motion.span
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              ...
              >
                ...
                <span>{isPlaying ? "চলছে..." : "কী-প্রেস শুরু করো"}</span>
              </motion.button>
