...
function LoopFlowAnimation() {
  ...
  const steps = [
    { icon: "📝", label: "পুনরাবৃত্তি কাজ", color: "text-blue-400", bg: "bg-blue-900/30 border-blue-500/50" },
    { icon: "🔄", label: "লুপ ব্যবহার", color: "text-cyan-400", bg: "bg-cyan-900/30 border-cyan-500/50" },
    { icon: "⚡", label: "স্বয়ংক্রিয় পুনরাবৃত্তি", color: "text-amber-400", bg: "bg-amber-900/30 border-amber-500/50" },
    { icon: "📉", label: "কম কোড", color: "text-purple-400", bg: "bg-purple-900/30 border-purple-500/50" },
    { icon: "🚀", label: "দক্ষ!", color: "text-green-400", bg: "bg-green-900/30 border-green-500/50" },
  ];
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="bg-red-900/20 border border-red-500/30 rounded-2xl p-3">
          ...
          <div className="bg-gray-900 rounded-xl p-2 font-mono text-xs space-y-0.5">
            ...
            {withoutCount === 0 && <p className="text-gray-600 italic text-[10px]">শুরু করতে ক্লিক করুন...</p>}
          </div>
          {withoutCount >= 5 && (
