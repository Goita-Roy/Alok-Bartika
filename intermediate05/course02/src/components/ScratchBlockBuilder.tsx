...
export function ScratchBlockBuilder() {
  ...
  const [spaceAnimDone, setSpaceAnimDone] = useState(false);
      ...
      <div className="max-w-3xl mx-auto w-full">
        ...
        <Card className="overflow-hidden">
          ...
          <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 min-h-[200px]">
            <div className="text-xs text-muted dark:text-muted-dark font-bold mb-4">Blocks</div>
            ...
            {activityPhase === 'hat' && (
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-sm text-muted dark:text-muted-dark">এটিতে ক্লিক করে নিচে বসাও</p>
              </div>
            )}
                  ...
                  <>
                    ...
                    {showAnimation && (
                      <motion.div className="mt-4 text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                        <div className="flex items-center justify-center gap-2 text-sm font-bold text-text dark:text-text-dark">
                        ...
                        <motion.p className="text-sm text-muted dark:text-muted-dark mt-2">
          ...
          {showComplete && (
            ...
            >
              <Card highlighted className="text-center">
                ...
                <h3 className="text-2xl font-bold text-text dark:text-text-dark mb-2">দারুণ!</h3>
                <p className="text-text dark:text-text-dark">তুমি ইভেন্ট ব্লক ব্যবহার করে প্রোগ্রাম তৈরি করেছ!</p>
              </Card>
            </motion.div>
          )}
        </AnimatePresence>
