            ...
            <motion.div key="intro" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="text-center">
              <Card>
                ...
                <div className="bg-primary/10 border-2 border-primary rounded-xl p-4 mb-6">
                  ...
                  <p className="text-muted dark:text-muted-dark">একটি স্প্রাইটকে স্ক্রিনের বাম থেকে ডানে আজীবন বা চিরকাল হাঁটাতে হবে।</p>
                </div>
              ...
              <Card>
                ...
                <div className="flex justify-center mb-6">
                  <div className="border-4 border-purple-400 rounded-2xl p-6 pt-10 bg-purple-50 dark:bg-purple-900/20 min-w-[140px]">
                    ...
                    <div className="text-center text-muted dark:text-muted-dark text-sm py-2">
                      🐱 Move
                    </div>
                  </div>
                </div>
