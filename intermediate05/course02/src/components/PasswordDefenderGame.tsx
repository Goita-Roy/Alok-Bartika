...
const dragBlocks = [
  ...
  { id: 'welcome', label: '✅ Welcome', color: 'bg-primary' },
...
export function PasswordDefenderGame() {
  ...
  return (
    <section ref={ref} className="min-h-screen flex items-center justify-center py-20 px-4 bg-gradient-to-br from-gray-900 via-slate-800 to-gray-900">
