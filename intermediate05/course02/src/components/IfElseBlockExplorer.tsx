                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="ml-auto text-sm text-muted dark:text-muted-dark">{revealTrue ? '▲' : '▼'} ক্লিক করো</span>
                      </div>
                      <AnimatePresence>
                        {revealTrue && (
                          <motion.div
                    ...
                    >
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="ml-auto text-sm text-muted dark:text-muted-dark">{revealElse ? '▲' : '▼'} ক্লিক করো</span>
                      </div>
                      <AnimatePresence>
                        {revealElse && (
                          <motion.div
