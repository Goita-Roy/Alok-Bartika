...
const variants = {
  ...
  success:
    'bg-success hover:bg-green-600 text-white shadow-lg hover:shadow-xl',
  danger: 'bg-danger hover:bg-red-600 text-white shadow-lg hover:shadow-xl',
  ghost:
    'bg-white dark:bg-card-dark text-text dark:text-text-dark border-2 border-gray-200 dark:border-gray-600 hover:border-primary',
};
