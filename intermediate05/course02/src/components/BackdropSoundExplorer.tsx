      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                <button
                  ...
                  className={`w-full text-left cursor-pointer rounded-2xl border-2 px-6 py-4 font-mono text-lg font-bold transition-all duration-300 select-none ${b.color} ${
                    activeBlock === b.id
                      ? 'ring-4 ring-primary/40 scale-105 shadow-lg'
          ...
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            animate={isVisible ? { opacity: 1, x: 0 } : {}}
            className="bg-white dark:bg-card-dark rounded-2xl border-2 border-primary/20 overflow-hidden shadow-lg min-h-[260px] flex flex-col"
          >
            {/* Stage area */}
              ...
              <AnimatePresence mode="wait">
                {!active && (
                  <motion.p
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="text-muted dark:text-muted-dark text-center px-6"
                  >
            ...
            {/* Status bar */}
            <div className="border-t border-gray-200 dark:border-gray-700 px-4 py-2 bg-gray-50 dark:bg-gray-800/50 text-sm text-muted dark:text-muted-dark font-mono">
