    ...
    <section ref={ref} className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={isVisible ? { opacity: 1, x: 0 } : {}} className="bg-white dark:bg-card-dark rounded-2xl border-2 border-primary/20 p-8 flex items-center justify-center min-h-[300px] relative overflow-hidden shadow-lg">
            {!activeBlock && (
              <p className="text-muted dark:text-muted-dark text-lg text-center">যেকোনো একটি ব্লক নির্বাচন করো</p>
            )}
