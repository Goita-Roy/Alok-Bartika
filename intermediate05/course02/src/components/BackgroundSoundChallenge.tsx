    ...
    <section ref={ref} className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        <motion.div className="text-center mb-12" initial={{ opacity: 0, y: -20 }} animate={isVisible ? { opacity: 1, y: 0 } : {}}>
          ...
          <p className="text-xl text-muted dark:text-muted-dark max-w-xl mx-auto">
        ...
        <Card className="p-8 bg-white dark:bg-card-dark border-2 border-primary/20">
          ...
          <div className="max-w-md mx-auto bg-gray-100 dark:bg-gray-900 rounded-2xl p-6 mb-8">
            ...
            <div
              ...
              className={`h-14 rounded-t-2xl rounded-b-none border-2 border-dashed flex items-center justify-center transition-colors mb-0 ${slots[0] ? 'border-transparent' : 'border-gray-400 dark:border-gray-600 bg-white/60 dark:bg-gray-800 hover:border-primary'}`}
            >
              {slots[0] ? (
            ...
            <div className="flex flex-col gap-1 bg-yellow-300/30 dark:bg-yellow-900/20 rounded-b-2xl px-3 pb-3 pt-1 border-l-2 border-r-2 border-b-2 border-dashed border-yellow-400 dark:border-yellow-700">
              {[1, 2].map(idx => (
                <div
                  ...
                  onDragOver={handleDragOver}
                  className={`h-12 rounded-lg border-2 border-dashed flex items-center justify-center transition-colors ${slots[idx] ? 'border-transparent' : 'border-gray-400 dark:border-gray-600 bg-white/40 hover:border-primary'}`}
                >
                  {slots[idx] ? (
