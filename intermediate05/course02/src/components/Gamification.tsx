...
export function Gamification() {
  ...
  return (
    <section
      ref={ref}
      className="min-h-screen flex items-center justify-center py-20 px-4 bg-gradient-to-br from-rose-50 to-purple-50 dark:from-gray-900 dark:to-slate-900 relative"
    >
      ...
      <div className="max-w-3xl mx-auto w-full">
        ...
        <Card className="mb-8">
          ...
          {/* XP Progress Bar */}
          <div className="mb-4">
            <div className="flex justify-between text-sm text-muted dark:text-muted-dark mb-1">
              <span>XP: {xp}</span>
              <span>/{maxXp}</span>
            </div>
              ...
              <motion.div
                ...
                className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm border-2 ${
                  completedLevels.has(i)
                    ...
                    : 'bg-gray-100 dark:bg-gray-700 text-muted dark:text-muted-dark border-gray-200 dark:border-gray-600'
                }`}
          ...
          <AnimatePresence mode="wait">
            ...
            {status === 'success' && (
              ...
              >
                ...
                <p className="text-lg text-text dark:text-text-dark mb-4">
                ...
                <div className="space-y-2 mb-6">
                  {items.map((item, i) => {
                    ...
                    return (
                      ...
                      >
                        <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold bg-gray-200 dark:bg-gray-600 text-text dark:text-text-dark">
                          {i + 1}
                        </span>
                        ...
                        {!correct && (
                          <span className="text-danger text-sm ml-auto">✗</span>
                        )}
                      </div>
                    );
                  })}
